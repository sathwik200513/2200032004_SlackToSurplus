...
<body>
    <header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <!-- <li><a href="fooddonate.jsp">Donate</a></li> -->
            </ul>
        </nav>
    </header>
    ...
    <section class="banner">
        <a href="fooddonateform.jsp">Donate Food</a>
    </section>
    ...
    <div class="photo">
        ...
        <br>
        <div class="wrapper">
            <div class="box"><img src="images/p1.jpeg" alt=""></div>
            <div class="box"><img src="images/p4.jpeg" alt=""></div>
            <div class="box"><img src="images/p3.jpeg" alt=""></div>
        </div>
        <br>
    </div>
    ...
    <div class="deli" style="display: grid;">
        ...
        <br>
        <p class="para">"Your donation will be immediately collected and sent to needy people"</p>
    ...
    <footer class="footer">
        <div class="footer-left col-md-4 col-sm-6">
            <p class="about">
                <span>About us:</span> The basic concept of this project is Food Waste Management, which involves collecting excess or leftover food from donors, such as hotels, restaurants, marriage halls, etc., and distributing it to needy people.
            </p>
        </div>
